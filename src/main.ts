...
function showHelp(): void {
      ...
      <div class="content">
        <div class="section">
          ...
          <ul class="feature-list">
            <li><strong>Две иконки в трее</strong> — первая показывает температуру в виде текста (например, <code>5°</code>, <code>-13°</code>), вторая показывает погодные условия (эмодзи: ☀️, ☁️, 🌧️)</li>
            <li><strong>Автоматическое обновление</strong> — данные обновляются каждую минуту (или с настраиваемым интервалом)</li>
            <li><strong>Гибкая настройка местоположения</strong> — можно указать либо координаты, либо город и страну (взаимно исключающие варианты)</li>
            <li><strong>Время последнего обновления</strong> — показывается в tooltip и меню с точностью до секунды, включая часовой пояс и UTC offset</li>
            <li><strong>Информация о местоположении</strong> — координаты, город и страна в контекстном меню</li>
            <li><strong>Подробная информация о погоде</strong> — окно с детальными параметрами (ощущается как, ветер, облачность, давление, влажность, видимость, точка росы, комфорт, осадки, восход/закат, УФ индекс и др.)</li>
            <li><strong>История ошибок API</strong> — сохраняются последние 20 ошибок для отладки</li>
            <li><strong>История API-запросов</strong> — сохраняются последние 20 запросов с полными деталями (URL, заголовки, тело ответа)</li>
            <li><strong>Удобные настройки</strong> — диалог с быстрым выбором популярных городов</li>
            <li><strong>Системные уведомления</strong> — уведомления о сохранении настроек</li>
            <li><strong>Умное позиционирование окон</strong> — все окна открываются на основном мониторе</li>
            <li><strong>Предотвращение дублирования окон</strong> — повторное открытие активирует уже открытое окно</li>
          </ul>
        </div>
        ...
        <div class="section">
          ...
          <div style="background: #fff3cd; border: 1px solid #ffc107; border-radius: 4px; padding: 12px; margin-bottom: 16px;">
            ...
            <p style="margin: 8px 0 0 0; color: #856404; font-weight: 500;"><strong>⚠️ Важно:</strong> Необходимо указать <strong>либо</strong> город и страну, <strong>либо</strong> координаты. Оба варианта одновременно указывать нельзя.</p>
          </div>
          ...
          <ol>
            ...
            <li>В открывшемся окне заполните необходимые поля:
              <ul>
                <li><strong>Город и Страна</strong> — координаты будут определены автоматически</li>
                <li><strong>Широта и Долгота</strong> — название города и страны будут определены автоматически</li>
              </ul>
            </li>
            <li>Используйте <strong>быстрый выбор города</strong> для популярных городов (Warsaw, Minsk, Astana, Berlin, Paris, New York)</li>
            <li>Нажмите кнопку <strong>"Сохранить"</strong></li>
          </ol>
          <p>Диалог автоматически проверит корректность введённых данных и применит настройки. Приложение продолжит работать с новыми настройками без перезапуска. После сохранения появится системное уведомление.</p>
  ...
  "updateIntervalInSeconds": 60
          ...
          <p>Название города и страны будут определены автоматически по координатам через Nominatim (OpenStreetMap) API.</p>
        </div>
        ...
        <div class="section">
          ...
          <h3>Иконки в трее</h3>
          <p><strong>Первая иконка</strong> — температура отображается <span class="highlight">прямо на иконке</span> в виде текста (например, <code>5°</code>, <code>-13°</code>).</p>
          <p><strong>Вторая иконка</strong> — погодные условия отображаются в виде эмодзи (☀️, ☁️, 🌧️, ❄️ и т.д.).</p>
          <p>Иконки обновляются каждую минуту (или с настраиваемым интервалом).</p>

          <h3>Левый клик по иконке</h3>
          <p>Открывает окно с <strong>подробной информацией о погоде</strong> с детальными параметрами.</p>

          <h3>Tooltip (при наведении)</h3>
          <p>Показывает одинаковую информацию для обеих иконок:</p>
          <ul>
            <li>Название города и страны (если доступно)</li>
            <li>Текущую температуру</li>
            <li>Ощущается как (feels like)</li>
            <li>Время последнего успешного обновления с секундами, часовым поясом и UTC offset</li>
          </ul>
          <p>Пример: <code>Нью-Йорк, США\nТемпература: 0.2 °C\nОщущается как: -2.5 °C\nОбновлено: 2024-01-15T14:35:42 (America/New_York, UTC-05:00)</code></p>
          ...
          <ul>
            ...
            <li>Пункт <strong>"Подробная информация о погоде"</strong> для открытия окна с детальными параметрами</li>
            <li>Пункт <strong>"Настройки"</strong> для редактирования настроек через диалог</li>
            <li>Пункт <strong>"Как пользоваться"</strong> для просмотра справки</li>
            <li>Пункт <strong>"Показать ошибки API (N)"</strong> для просмотра истории ошибок</li>
            <li>Пункт <strong>"Показать последние API-запросы"</strong> для просмотра истории запросов</li>
            <li>Пункт <strong>"Выйти"</strong></li>
          </ul>

          <h3>Подробная информация о погоде</h3>
          <p>Окно с детальными параметрами погоды открывается:</p>
          <ul>
            <li><strong>Левым кликом</strong> по любой иконке в трее</li>
            <li>Через пункт меню <strong>"Подробная информация о погоде"</strong></li>
          </ul>
          <p>Окно показывает:</p>
          <ul>
            <li>Текущую температуру</li>
            <li>Ощущается как</li>
            <li>Ветер (скорость в м/с, направление, описание)</li>
            <li>Облачность (%)</li>
            <li>Давление (гПа)</li>
            <li>Влажность (%)</li>
            <li>Видимость (км)</li>
            <li>Точку росы (°C)</li>
            <li>Уровень комфорта</li>
            <li>Осадки (мм)</li>
            <li>Восход солнца (с часовым поясом и UTC offset)</li>
            <li>Закат солнца (с часовым поясом и UTC offset)</li>
            <li>Продолжительность светового дня</li>
            <li>УФ индекс</li>
            <li>Время обновления (с часовым поясом и UTC offset)</li>
          </ul>
          <p>Все времена отображаются в том же формате, в котором они были получены от API, с указанием часового пояса и UTC offset.</p>
        </div>
          ...
          <ol>
            ...
            <li>Откроется окно с подробной информацией о каждой ошибке:
              <ul>
                ...
                <li>HTTP статус код (если доступен)</li>
                <li>Код ошибки Node.js (если доступен)</li>
              </ul>
            </li>
          </ol>
          <p>Если ошибок нет, откроется окно с сообщением об отсутствии ошибок.</p>
        </div>

        <div class="section">
          <h2>📡 История API-запросов</h2>
          <p>Приложение сохраняет последние 20 API-запросов с полными деталями. Для просмотра:</p>
          <ol>
            <li>Кликните правой кнопкой мыши на иконку в трее</li>
            <li>Выберите пункт <strong>"Показать последние API-запросы"</strong></li>
            <li>Откроется окно с подробной информацией о каждом запросе:
              <ul>
                <li>Время запроса</li>
                <li>Название API</li>
                <li>URL запроса (кликабельный)</li>
                <li>HTTP метод</li>
                <li>Заголовки запроса</li>
                <li>HTTP статус код ответа</li>
                <li>Заголовки ответа</li>
                <li>Полное тело ответа (JSON)</li>
                <li>Длительность запроса (мс)</li>
              </ul>
            </li>
          </ol>
          <p>Если запросов нет, откроется окно с сообщением об отсутствии запросов.</p>
        </div>
        ...
        <div class="section">
          ...
          <ul>
            ...
            <li><strong>API геокодирования (прямое):</strong> <a href="https://geocoding-api.open-meteo.com" class="url-link">Open-Meteo Geocoding</a></li>
            <li><strong>API геокодирования (обратное):</strong> <a href="https://nominatim.openstreetmap.org" class="url-link">Nominatim (OpenStreetMap)</a></li>
            <li><strong>Создание иконок:</strong> Canvas (для отрисовки текста температуры и эмодзи)</li>
            <li><strong>Конфигурация:</strong> <code>settings.json</code> файл</li>
            <li><strong>Кэширование эмодзи:</strong> Только на Linux (для оптимизации производительности)</li>
          </ul>
        </div>
      </div>
    </body>
